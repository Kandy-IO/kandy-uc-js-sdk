...
-   `camera` **[Array][7]&lt;[call.DeviceInfo][25]>** A list of camera device information.
-   `microphone` **[Array][7]&lt;[call.DeviceInfo][25]>** A list of microphone device information.
-   `speaker` **[Array][7]&lt;[call.DeviceInfo][25]>** A list of speaker device information.
...
Returns **[Array][7]&lt;[call.CallObject][42]>** Call objects.
...
-   `type` **[string][5]** The type of message that was sent. See [conversation.chatTypes][57] for valid types.
...
-   `status` **[string][5]** The current status the user has set for themselves. For supported values see [presence.statuses][70].
...
The SDK will emit a [users:change][77]
...
Compared to [user.fetch][79] API, this API retrieves additional user related information.
...
See the [user.fetch][79] and [user.search][80] APIs for details about
...
Returns **[user.User][81]** The User object for the specified user.
...
Returns **[Array][7]&lt;[user.User][81]>** An array of all the User objects.
...
The SDK will emit a [directory:change][82]
   ...
   [user.get][78] and [user.getAll][83] APIs.
