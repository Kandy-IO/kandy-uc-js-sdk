...
-   `call` **[Object][4]** The call configuration object.
    ...
    -   `call.iceServers` **[Array][7]&lt;[call.IceServer][9]>?** The list of ICE servers to be used for calls.
    ...
    -   `call.iceCollectionCheck` **[Function][10]?** Function to check whether collected candidates
    ...
    -   `call.resyncOnConnect` **[boolean][8]** Whether the SDK should re-sync all call states after connecting (requires Kandy Link 4.7.1+). (optional, default `false`)
...
-   `urls` **([Array][7]&lt;[string][5]> | [string][5])** Either an array of URLs for reaching out several ICE servers or a single URL for reaching one ICE server. See [RTCIceServers.urls documentation][26] to learn more about the actual url format.
...
-   `tracks` **[Array][7]&lt;[call.TrackObject][28]>** A list of Track objects that are contained in this Media object.
...
-   `state` **[string][5]** The current state of the call. See [call.states][29] for possible states.
...
-   `customParameters` **[Array][7]&lt;[call.CustomParameter][31]>** The custom parameters set for the call.
...
-   `camera` **[Array][7]&lt;[call.DeviceInfo][32]>** A list of camera device information.
-   `microphone` **[Array][7]&lt;[call.DeviceInfo][32]>** A list of microphone device information.
-   `speaker` **[Array][7]&lt;[call.DeviceInfo][32]>** A list of speaker device information.
...
-   `options` **[Object][4]?** 
    ...
    -   `options.customParameters` **[Array][7]&lt;[call.CustomParameter][31]>?** Custom SIP header parameters for the SIP backend
...
-   `customParameters` **[Array][7]&lt;[call.CustomParameter][31]>** The custom parameters to set.
...
-   `type` **[string][5]** The type of message that was sent. See [conversation.chatTypes][60] for valid types.
...
-   `params` **[Object][4]** 
    ...
    -   `params.isProduction` **[boolean][8]** If true, push notification will be sent to production.
...
Returns **[Array][7]&lt;[user.User][85]>** An array of all the User objects.
