...
The SDK will emit a [users:change][90]
...
Compared to [user.fetch][92] API, this API retrieves additional user related information.
...
See the [user.fetch][92] and [user.search][93] APIs for details about
...
Returns **[user.User][94]** The User object for the specified user.
...
Returns **[Array][13]&lt;[user.User][94]>** An array of all the User objects.
...
The SDK will emit a [directory:change][95]
   ...
   [user.get][91] and [user.getAll][96] APIs.
