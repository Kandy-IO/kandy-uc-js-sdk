...
to be used for all calls, or with the [call.setSdpHandlers][86] Call API post-instantiation.
...
The SDK will emit a [users:change][87]
...
Compared to [user.fetch][89] API, this API retrieves additional user related information.
...
See the [user.fetch][89] and [user.search][90] APIs for details about
...
Returns **[user.User][91]** The User object for the specified user.
...
Returns **[Array][12]&lt;[user.User][91]>** An array of all the User objects.
...
The SDK will emit a [directory:change][92]
   ...
   [user.get][88] and [user.getAll][93] APIs.
