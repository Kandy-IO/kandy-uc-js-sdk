...
- Fixed an issue introduced in v5.1.1 causing the SDK to fail to initialize.
...
- Added new call events: `call:tracksAdded` and `call:tracksRemoved`
  ...
  - For more information, please see the [API documentation](https://kandy-io.github.io/kandy-uc-js-sdk/docs/#calleventcalltracksadded) for these events.
- Added new track event: `media:trackEnded`
  ...
  - For more information, please see the [API documentation](https://kandy-io.github.io/kandy-uc-js-sdk/docs/#mediaeventmediatrackEnded) for this event.
...
- Added a Call config `iceCollectionCheckFunction` to allow for configuration of the ICE candidate collection process. `KJS-449`
  ...
  - See [IceCollectionCheckFunction documentation](https://kandy-io.github.io/kandy-uc-js-sdk/docs/#callicecollectioncheckfunction) for more information.
...
- Changed the default ICE Collection Check Function functionality. `KJS-450`
  ...
  - The new change takes into account the number of media transports, and configured TURN servers. For more information, see [IceCollectionCheckFunction documentation](https://kandy-io.github.io/kandy-uc-js-sdk/docs/#callicecollectioncheckfunction).
...
- Added a new property to the `CallObject` called `mediaConnectionState`, which tracks the underlying media connection state of a call. `KJS-141`, `KJS-223`
  - A new call event [`call:mediaConnectionChange`](https://kandy-io.github.io/kandy-uc-js-sdk/docs/#calleventcallmediaconnectionchange) is also emitted every time the media connection state is changed.
...
- Added support for handling subscription gone notification. `KJS-215`
...
- Action logs are now disabled by default. The client can provide either a boolean or an object with action log configuration details. If `logActions` is set to `true`, the default settings for action logs will be used. See [Config documentation](https://kandy-io.github.io/kandy-uc-js-sdk/docs/#config). `KAA-2504`
